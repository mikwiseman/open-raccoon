...
const EXECUTION_MODES: Array<{ value: ExecutionMode; label: string; description: string }> = [
  { value: "raw", label: "Raw Streaming", description: "Direct LLM streaming with manual tool handling" },
  { value: "claude_sdk", label: "Claude Agent SDK", description: "Agentic loop with Claude's tool_use" },
  { value: "openai_sdk", label: "OpenAI Agents SDK", description: "OpenAI function calling with agent loop" },
];
    ...
    <fieldset className="ab-fieldset" aria-label="model-selector">
      ...
      <div className="ab-field-grid">
        <div className="ab-field">
          <label className="ab-label" htmlFor="model-select">Model</label>
          <select
            id="model-select"
            className="ab-select"
            value={model}
        ...
        <div className="ab-field">
          <label className="ab-label" htmlFor="execution-mode-select">Execution Mode</label>
          <select
        ...
        <div className="ab-field">
          <label className="ab-label" htmlFor="max-tokens-input">Max Tokens</label>
          <input
            id="max-tokens-input"
            type="number"
            className="ab-input"
