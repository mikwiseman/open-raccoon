  ...
  return (
    <form className="ab-mcp-form" onSubmit={handleSubmit} aria-label="mcp-server-form">
      ...
      <div className="ab-field">
        <label className="ab-label" htmlFor="mcp-name">Name</label>
        <input
          id="mcp-name"
          className="ab-input"
          value={name}
      ...
      <div className="ab-field">
        <label className="ab-label" htmlFor="mcp-transport">Transport</label>
        <select
          id="mcp-transport"
          className="ab-select"
          value={transport}
      ...
      {transport === "stdio" ? (
        <>
          <div className="ab-field">
            <label className="ab-label" htmlFor="mcp-command">Command</label>
            <input
              id="mcp-command"
              className="ab-input"
              value={command}
          ...
          <div className="ab-field">
            <label className="ab-label" htmlFor="mcp-args">Arguments (comma-separated)</label>
            <input
              id="mcp-args"
              className="ab-input"
              value={args}
        ...
        <div className="ab-field">
          <label className="ab-label" htmlFor="mcp-url">URL</label>
          <input
            id="mcp-url"
            className="ab-input"
            type="url"
      ...
      <div className="ab-field">
        <label className="ab-label" htmlFor="mcp-env">Environment Variables (KEY=VALUE per line)</label>
        <textarea
          id="mcp-env"
      ...
      <div className="ab-field">
        <label className="ab-label" htmlFor="mcp-headers">Headers (Key: Value per line)</label>
        <textarea
          id="mcp-headers"
          className="ab-textarea"
          value={headersText}
