          ...
          {loading ? (
            ...
            <div style={{ display: 'grid', gap: 'var(--space-3)' }}>
              ...
              <div style={usageNumbersStyle}>
                <span style={usageCountStyle}>{usage.tokens_used.toLocaleString()}</span>
            ...
            <p
              style={{ margin: 0, color: 'var(--color-text-tertiary)', fontSize: 'var(--text-sm)' }}
            >
              {usageUnavailable
                  ...
                  {bridges.map((bridge) => (
                    <li key={bridge.id} style={bridgeItemStyle}>
                      <div style={bridgeInfoStyle}>
                        ...
                        >
                          {bridge.status}{' '}
                          {bridge.last_sync_at ? `· synced ${toIsoLocal(bridge.last_sync_at)}` : ''}
                        </span>
                      </div>
                      <button
                        type="button"
