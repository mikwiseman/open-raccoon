defmodule RaccoonBridges.BridgeConnection do
  ...
  schema "bridge_connections" do
    ...
    field :status, Ecto.Enum, values: [:connected, :reconnecting, :disconnected, :error], default: :disconnected
  ...
  def changeset(bridge, attrs) do
    bridge
    |> cast(attrs, [:user_id, :platform, :method, :status, :encrypted_credentials, :metadata, :last_sync_at])
