...
async function seed() {
  ...
  const userAttrs = [
    {
      ...
      bio: "Full-stack developer. Building tools that make developers' lives easier.",
    },
    {
      username: 'maya_writer',
      display_name: 'Maya Johnson',
      email: 'maya@openraccoon.com',
      bio: 'Content creator and copywriter. Words are my superpower.',
    },
    {
      username: 'sam_designer',
      display_name: 'Sam Rivera',
      email: 'sam@openraccoon.com',
      bio: 'UI/UX designer and illustrator. Making the web beautiful.',
    },
    {
      username: 'jordan_student',
      display_name: 'Jordan Park',
      email: 'jordan@openraccoon.com',
      bio: 'CS student. Learning something new every day.',
    },
    {
      username: 'taylor_data',
      display_name: 'Taylor Kim',
      email: 'taylor@openraccoon.com',
      bio: 'Data scientist. Finding stories hidden in numbers.',
    },
    {
      username: 'riley_pm',
      display_name: 'Riley Morgan',
      email: 'riley@openraccoon.com',
      bio: 'Product manager. Shipping great products, one sprint at a time.',
    },
    {
      username: 'casey_research',
      display_name: 'Casey Williams',
      email: 'casey@openraccoon.com',
      bio: 'PhD researcher in NLP. Exploring the frontiers of language AI.',
    },
    {
      username: 'morgan_maker',
      display_name: 'Morgan Lee',
      email: 'morgan@openraccoon.com',
      bio: 'Indie maker. I ship something new every week.',
    },
    {
      username: 'avery_teacher',
      display_name: 'Avery Thompson',
      email: 'avery@openraccoon.com',
      bio: 'High school CS teacher. Inspiring the next generation of coders.',
    },
    {
      username: 'quinn_admin',
      display_name: 'Quinn Davis',
      email: 'quinn@openraccoon.com',
      bio: 'Platform moderator. Keeping the community safe and welcoming.',
    },
  ];
  ...
  const agentDefs = [
    {
      ...
      category: 'coding',
      system_prompt:
        'You are an expert pair programmer and coding assistant. You write clean, well-documented, production-ready code. You explain your reasoning clearly, suggest best practices, and help debug issues efficiently. You support all major programming languages and frameworks.',
      description:
        'Expert pair programmer that writes clean, documented code and helps debug issues.',
    },
    {
      creator: 'maya_writer',
      name: 'Writing Coach',
      ...
      category: 'writing',
      system_prompt:
        'You are a skilled writing coach and editor. You help improve grammar, tone, and structure. You adapt to different writing styles — from technical documentation to creative prose. You provide constructive feedback and specific suggestions for improvement.',
      description: 'Helps with grammar, tone, and structure for any type of writing.',
    },
    {
      creator: 'sam_designer',
      name: 'Design Helper',
      slug: 'design-helper',
      category: 'creative',
      system_prompt:
        'You are a UI/UX design consultant. You provide advice on color theory, layout composition, typography, and accessibility. You help create cohesive design systems and review designs for usability issues. You stay current with modern design trends.',
    ...
    },
    {
      ...
      category: 'data',
      system_prompt:
        'You are a data analysis expert. You help write SQL queries, Python pandas code, and create data visualizations. You explain statistical concepts clearly and help interpret data findings. You suggest appropriate analysis methods for different types of data.',
    ...
    },
    {
      ...
      system_prompt:
        'You are an experienced project manager and planning assistant. You help with sprint planning, roadmap creation, task prioritization, and resource allocation. You use frameworks like RICE, MoSCoW, and story mapping. You keep teams focused on delivering value.',
      description: 'Sprint planning, roadmaps, prioritization, and team coordination.',
    },
    {
      creator: 'casey_research',
      name: 'Research Navigator',
      slug: 'research-navigator',
      category: 'other',
      system_prompt:
        'You are an academic research assistant. You help analyze research papers, conduct literature reviews, identify research gaps, and suggest methodologies. You understand citation formats, statistical methods, and academic writing conventions.',
      description: 'Academic paper analysis, literature review, and research methodology guidance.',
    },
    {
      creator: 'morgan_maker',
      name: 'Fun Chat Bot',
      slug: 'fun-chat-bot',
      category: 'other',
      system_prompt:
        'You are a friendly and entertaining conversational companion. You tell jokes, share interesting trivia, play word games, and keep conversations fun and engaging. You have a warm personality and enjoy making people laugh while keeping things appropriate.',
      description: 'Casual conversation, jokes, trivia, and fun word games.',
    },
    {
      creator: 'avery_teacher',
      name: 'Study Buddy',
      slug: 'study-buddy',
      category: 'education',
      system_prompt:
        'You are a patient and encouraging tutor. You explain complex concepts in simple terms, create practice problems, and adapt your teaching style to each student. You cover computer science, math, and science topics. You celebrate progress and encourage curiosity.',
  ...
  for (const a of agentDefs) {
    ...
    const soulBlocks = [
      ...
      {
        label: 'preferences',
        content: 'Respond clearly and concisely. Use examples when helpful.',
      },
    ];
  ...
  await createConversation(
    ...
    [
      { user_id: alex, role: 'owner' },
      { user_id: maya, role: 'member' },
    ],
    [
      {
        sender_id: alex,
        sender_type: 'user',
        text: "Hey Maya! I've been thinking about building a blog-writing agent. Would you be interested in collaborating?",
      },
      {
        sender_id: maya,
        sender_type: 'user',
        text: 'That sounds awesome! I could help design the writing prompts and style guidelines.',
      },
      {
        sender_id: alex,
        sender_type: 'user',
        text: "Perfect. I'll set up the agent config and we can iterate on the system prompt together.",
      },
      {
        sender_id: maya,
        sender_type: 'user',
        text: "Looking forward to it! Send me a draft when you have something and I'll review the tone and structure.",
      },
    ],
  );
  ...
  await createConversation(
    ...
    [
      ...
      { user_id: avery, role: 'member' },
    ],
    [
      {
        sender_id: jordan,
        sender_type: 'user',
        text: "Hey Avery, I'm stuck on the recursion homework. Can binary search really be implemented recursively?",
      },
      {
        sender_id: avery,
        sender_type: 'user',
        text: 'Absolutely! Think of it this way: each recursive call narrows the search space by half. The base case is when left > right.',
      },
      {
        sender_id: jordan,
        sender_type: 'user',
        text: 'Oh that makes sense! So the midpoint check decides which half to recurse into. Thanks!',
      },
    ],
  );
  ...
  await createConversation(
    ...
    [
      { user_id: morgan, role: 'owner' },
      { user_id: alex, role: 'member' },
      { user_id: sam, role: 'member' },
    ],
    [
      {
        sender_id: morgan,
        sender_type: 'user',
        text: "Who's in for a weekend hackathon? I want to build something with the agent API.",
      },
      {
        sender_id: alex,
        sender_type: 'user',
        text: "I'm in! I've been wanting to try chaining multiple agents together for a code review pipeline.",
      },
      {
        sender_id: sam,
        sender_type: 'user',
        text: 'Count me in too. I can design the UI while you two handle the backend.',
      },
      {
        sender_id: morgan,
        sender_type: 'user',
        text: "Let's do it Saturday 10am. I'll set up the repo and share the link.",
      },
    ],
  );
    ...
    [
      {
        sender_id: jordan,
        sender_type: 'user',
        text: 'Can you explain how recursion works? I keep getting stack overflow errors.',
      },
      {
        sender_id: agentMap['study-buddy'],
        sender_type: 'agent',
        text: "Great question! Recursion is when a function calls itself to solve smaller subproblems. The key ingredients are:\n\n1. **Base case** — a condition where the function stops calling itself\n2. **Recursive case** — the function calls itself with a simpler input\n\nStack overflows happen when there's no base case, or the input doesn't get smaller.",
      },
      {
        sender_id: jordan,
        sender_type: 'user',
        text: 'Yes please! Give me something to practice with.',
      },
    ],
  );
  ...
  await createConversation(
    {
      ...
      creator_id: riley,
      agent_id: agentMap['project-planner'],
    },
  ...
  const feedDefs = [
    {
      creator: 'alex_dev',
      agent_slug: 'code-assistant',
      title: 'Code Assistant — Your AI Pair Programmer',
      description:
        'Meet Code Assistant: a pair programmer that writes clean, documented code across all major languages.',
    },
    {
      creator: 'maya_writer',
      agent_slug: 'writing-coach',
      title: 'Writing Coach — Polish Your Prose',
      description:
        "Whether you're writing docs, blog posts, or marketing copy, Writing Coach helps you nail the tone.",
    },
    {
      creator: 'sam_designer',
      agent_slug: 'design-helper',
      title: 'Design Helper — UI/UX at Your Fingertips',
      description:
        'Get instant design feedback, color palette suggestions, and accessibility audits.',
    },
    {
      creator: 'taylor_data',
      ...
      description:
        'Stop struggling with SQL and pandas. Data Analyzer helps you query, transform, and visualize data.',
    },
    {
      creator: 'avery_teacher',
      agent_slug: 'study-buddy',
      title: 'Study Buddy — Learn Anything, Your Way',
      description:
        'A patient tutor that adapts to your learning style. Great for CS, math, and science.',
    },
    {
      creator: 'morgan_maker',
      agent_slug: 'fun-chat-bot',
      title: 'Fun Chat Bot — Your Daily Dose of Joy',
      description: 'Need a break? Fun Chat Bot tells jokes, shares trivia, and plays word games.',
    },
  ];
  ...
  const ratingDefs = [
    {
      rater: 'jordan_student',
      agent_slug: 'study-buddy',
      rating: 5,
      review: 'Explains things so clearly!',
    },
    {
      rater: 'riley_pm',
      agent_slug: 'project-planner',
      rating: 4,
      review: 'Great for sprint planning',
    },
    {
      rater: 'maya_writer',
      agent_slug: 'code-assistant',
      rating: 5,
      review: 'Writes clean, well-documented code',
    },
    {
      rater: 'alex_dev',
      agent_slug: 'writing-coach',
      rating: 4,
      review: 'Really improved my documentation',
    },
    {
      rater: 'morgan_maker',
      agent_slug: 'data-analyzer',
      rating: 5,
      review: 'Perfect for quick data exploration',
    },
