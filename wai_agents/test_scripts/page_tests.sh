#!/usr/bin/env bash
# page_tests.sh — Page CRUD, deploy, versioning, forking, and negative tests for WaiAgents
# Uses pre-created test user tokens from /tmp/wai_agents_test_tokens.env
