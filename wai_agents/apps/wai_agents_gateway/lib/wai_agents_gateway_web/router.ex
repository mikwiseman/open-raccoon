defmodule WaiAgentsGatewayWeb.Router do
  use WaiAgentsGatewayWeb, :router
  ...
  pipeline :authenticated do
    plug WaiAgentsGatewayWeb.Plugs.Auth
    plug WaiAgentsGatewayWeb.Plugs.RateLimit, category: :general
  end

  pipeline :auth_rate_limited do
    plug WaiAgentsGatewayWeb.Plugs.RateLimit, category: :auth
  end

  # Public health check (no auth required)
  scope "/api/v1", WaiAgentsGatewayWeb do
    pipe_through :api
  ...
  scope "/api/v1/auth", WaiAgentsGatewayWeb do
  ...
  scope "/auth", WaiAgentsGatewayWeb do
