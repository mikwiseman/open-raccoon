defmodule WaiAgentsGatewayWeb.ConversationChannel do
  @moduledoc """
  ...
  use WaiAgentsGatewayWeb, :channel

  alias WaiAgentsChat
  alias WaiAgentsChat.Delivery
  alias WaiAgentsChat.Typing
  alias WaiAgentsChat.ReadReceipts
  alias WaiAgentsGatewayWeb.Presence
  ...
  def handle_in("react", %{"message_id" => message_id, "emoji" => emoji}, socket) do
    ...
    with %{} <- WaiAgentsChat.get_message_in_conversation(conversation_id, message_id),
         {:ok, _reaction} <-
           WaiAgentsChat.add_reaction(%{message_id: message_id, user_id: user_id, emoji: emoji}),
         %{} = updated_message <-
           WaiAgentsChat.get_message_with_reactions(conversation_id, message_id) do
