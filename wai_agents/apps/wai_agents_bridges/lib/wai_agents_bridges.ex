defmodule WaiAgentsBridges do
  @moduledoc """
  Bridges context: bridge connection management, status tracking.
  """

  alias WaiAgentsShared.Repo
  alias WaiAgentsBridges.BridgeConnection
  alias WaiAgentsBridges.Adapters.{Telegram, WhatsApp}
  alias WaiAgentsChat.{Conversation, Delivery}
  import Ecto.Query
