defmodule WaiAgentsBridges.CredentialEncryption do
  @moduledoc """
  ...
  @aad "WaiAgentsBridges.CredentialEncryption"
  ...
  defp encryption_key do
    Application.fetch_env!(:wai_agents_bridges, :bridge_encryption_key)
    |> Base.decode64!()
  end
end
