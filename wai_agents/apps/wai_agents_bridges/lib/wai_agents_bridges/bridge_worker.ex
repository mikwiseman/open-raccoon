defmodule WaiAgentsBridges.BridgeWorker do
  @moduledoc """
  ...
  alias WaiAgentsBridges.Adapters.Telegram
  ...
  def via(bridge_id) do
    {:via, Registry, {WaiAgentsBridges.Registry, bridge_id}}
  end
          ...
          {:ok, updates} ->
            Enum.each(updates, fn update ->
              case Telegram.handle_webhook(update) do
                ...
                {:ok, envelope} ->
                  WaiAgentsBridges.route_telegram_envelope(bridge, envelope)
