defmodule WaiAgentsBridges.Adapters.WhatsApp do
  @moduledoc """
  ...
  alias WaiAgentsShared.MessageEnvelope
  alias WaiAgentsShared.Media.{R2, CDN}
  ...
  def verify_webhook(params) do
    ...
    expected_token = Application.get_env(:wai_agents_bridges, :whatsapp_verify_token)
