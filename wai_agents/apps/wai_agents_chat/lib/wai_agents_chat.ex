defmodule WaiAgentsChat do
  ...
  alias WaiAgentsChat.{Conversation, ConversationMember, Message, MessageReaction}
  alias Ecto.Multi
  import Ecto.Query
  ...
  Delegates to `WaiAgentsChat.Delivery.send_message/3` which handles validation,
  persistence, broadcasting, and notification.
  """
  defdelegate send_message(conversation_id, sender_id, params), to: WaiAgentsChat.Delivery
