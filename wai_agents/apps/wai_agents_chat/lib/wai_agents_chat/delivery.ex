defmodule WaiAgentsChat.Delivery do
  @moduledoc """
  ...
  alias WaiAgentsChat.Message
  alias WaiAgentsChat.Conversation
  alias WaiAgentsChat.ConversationMember
  import Ecto.Query
  ...
  defp trigger_agent_execution(conversation, sender_id) do
    ...
    agent = WaiAgentsAgents.get_agent(agent_id)
    ...
    Task.Supervisor.start_child(
      WaiAgentsChat.TaskSupervisor,
      fn ->
        WaiAgentsAgents.AgentExecutor.execute(
          conversation_id,
          agent_id,
          sender_id,
          messages,
