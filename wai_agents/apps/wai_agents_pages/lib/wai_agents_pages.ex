defmodule WaiAgentsPages do
  @moduledoc """
  Pages context: page CRUD, deployment, versioning, forking.
  """

  alias WaiAgentsShared.Repo
  alias WaiAgentsPages.{Page, PageVersion, Deployer, VersionManager, Forking}
  import Ecto.Query
  ...
  @doc """
  Deploy a page to R2, create a new PageVersion, and generate a waiagents.page URL.
