defmodule WaiAgentsPages.Page do
  @moduledoc """
  Page schema for user-created web pages deployed to waiagents.page.
  """
  use Ecto.Schema
  ...
  schema "pages" do
    belongs_to(:creator, WaiAgentsAccounts.User)
    belongs_to(:agent, WaiAgentsAgents.Agent)
    belongs_to(:conversation, WaiAgentsChat.Conversation)
    belongs_to(:forked_from_page, WaiAgentsPages.Page, foreign_key: :forked_from)
    ...
    has_many(:versions, WaiAgentsPages.PageVersion)
