defmodule WaiAgentsShared.Media.CDN do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> WaiAgentsShared.Media.CDN.url("pages/abc123/index.html")
      "https://wai-agents.hel1.your-objectstorage.com/pages/abc123/index.html"
  """
  ...
  defp base_url do
    case Application.get_env(:wai_agents_shared, :cdn_base_url) do
      nil ->
        bucket = Application.fetch_env!(:wai_agents_shared, :spaces_bucket)
        region = Application.fetch_env!(:wai_agents_shared, :spaces_region)
        "https://#{bucket}.#{region}.your-objectstorage.com"
