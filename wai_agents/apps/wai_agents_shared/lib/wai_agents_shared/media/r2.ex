defmodule WaiAgentsShared.Media.R2 do
  @moduledoc """
  ...
  defp bucket do
    Application.fetch_env!(:wai_agents_shared, :spaces_bucket)
  end
  ...
  defp spaces_config do
    ...
    [
      access_key_id: Application.fetch_env!(:wai_agents_shared, :spaces_access_key),
      secret_access_key: Application.fetch_env!(:wai_agents_shared, :spaces_secret_key),
