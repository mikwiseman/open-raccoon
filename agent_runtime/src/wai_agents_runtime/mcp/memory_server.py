...
Run via: python -m wai_agents_runtime.mcp.memory_server
"""
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    agent_id = os.environ.get("WAI_AGENTS_AGENT_ID", "")
    user_id = os.environ.get("WAI_AGENTS_USER_ID", "")
    api_key = os.environ.get("WAI_AGENTS_OPENAI_API_KEY", "")
