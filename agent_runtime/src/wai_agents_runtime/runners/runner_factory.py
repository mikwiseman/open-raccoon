...
from wai_agents_runtime.runners.base_runner import BaseAgentRunner
...
class RunnerFactory:
    ...
    def create(
        ...
        match mode:
            ...
            case "claude_sdk":
                from wai_agents_runtime.runners.claude_runner import ClaudeRunner

                return ClaudeRunner(self.settings, api_key)
            case "openai_sdk":
                from wai_agents_runtime.runners.openai_runner import OpenAIRunner
